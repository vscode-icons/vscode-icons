...
function activate(context) {
    ...
    function diffDays(d1, d2) {
        ...
        var diffDays = Math.ceil(timeDiff / (1000 * 3600 * 24));txt
        return diffDays;
    }
