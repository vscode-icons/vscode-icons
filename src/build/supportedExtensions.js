...
exports.extensions = {
  supported: [
    ...
    { icon: 'ng2_component_js', extensions: ['.component.js'], filename: true, svg: true },
    { icon: 'ng2_directive_ts', extensions: ['.directive.ts'], filename: true, svg: true },
    { icon: 'ng2_directive_js', extensions: ['.directive.js'], filename: true, svg: true },
    { icon: 'ng2_pipe_ts', extensions: ['.pipe.ts'], filename: true, svg: true },
    { icon: 'ng2_pipe_js', extensions: ['.pipe.js'], filename: true, svg: true },
    { icon: 'ng2_service_ts', extensions: ['.service.ts'], filename: true, svg: true },
    { icon: 'ng2_service_js', extensions: ['.service.js'], filename: true, svg: true },
    { icon: 'ng2_module_ts', extensions: ['.module.ts'], filename: true, svg: true },
    { icon: 'ng2_module_js', extensions: ['.module.js'], filename: true, svg: true },
    ...
    { icon: 'node2', extensions: ['.nvmrc'], filename: true },
