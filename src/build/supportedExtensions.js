...
exports.extensions = {
  supported: [
    ...
    { icon: 'config', extensions: ['env', 'config', 'conf', 'cfg'] },
    ...
    { icon: 'git', extensions: ['.gitattributes', '.gitconfig', '.gitignore', '.gitmodules', '.gitkeep'], filename: true, languages: [languages.git] },
    ...
    { icon: 'ruby', extensions: [], languages: [languages.ruby] },
