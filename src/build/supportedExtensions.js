...
exports.extensions = {
  supported: [
    ...
    { icon: 'appveyor', extensions: ['appveyor.yml'], special: 'yml', contribType: ctype.filename },
    ...
    { icon: 'codeclimate', extensions: ['codeclimate.yml'], special: 'yml', contribType: ctype.filename },
    ...
    { icon: 'eslint', extensions: ['.eslintrc.js'], special: 'js', contribType: ctype.filename },
    { icon: 'eslint', extensions: ['.eslintrc.json'], special: 'json', contribType: ctype.filename },
    { icon: 'eslint', extensions: ['.eslintrc.yaml'], special: 'yaml', contribType: ctype.filename },
    { icon: 'eslint', extensions: ['.eslintrc.yml'], special: 'yml', contribType: ctype.filename },
    { icon: 'excel', extensions: ['xls', 'xlsx', 'csv', 'ods'] },
    { icon: 'favicon', extensions: ['favicon.ico'], special: 'ico', contribType: ctype.filename },
    ...
    { icon: 'gitlab', extensions: ['gitlab-ci.yml'], special: 'yml', contribType: ctype.filename },
    { icon: 'go', extensions: ['go'] },
    { icon: 'gradle', extensions: ['gradle'] },
    { icon: 'graphviz', extensions: [] },
    { icon: 'groovy', extensions: ['groovy'] },
    { icon: 'gruntfile', extensions: ['gruntfile.js'], special: 'js', contribType: ctype.filename },
    { icon: 'gulpfile', extensions: ['gulpfile.js'], special: 'js', contribType: ctype.filename },
    ...
    { icon: 'haxe', extensions: ['haxelib.json'], special: 'json', contribType: ctype.filename },
    { icon: 'haxecheckstyle', extensions: ['checkstyle.json'], special: 'json', contribType: ctype.filename },
    ...
    { icon: 'lerna', extensions: ['lerna.json'], special: 'json', contribType: ctype.filename },
    { icon: 'less', extensions: ['less'] },
    { icon: 'license', extensions: ['enc'] },
    { icon: 'license', extensions: ['license', 'licence'], contribType: ctype.filename },
    { icon: 'license', extensions: ['license.md', 'licence.md'], special: 'md', contribType: ctype.filename },
    { icon: 'lisp', extensions: ['bil'] },
    { icon: 'lime', extensions: ['hxp'] },
    { icon: 'lime', extensions: ['include.xml'], special: 'xml', contribType: ctype.filename },
    ...
    { icon: 'paket', extensions: ['paket.lock'], special: 'lock', contribType: ctype.filename },
    { icon: 'paket', extensions: ['paket.references'], special: 'references', contribType: ctype.filename },
    { icon: 'paket', extensions: ['paket.template'], special: 'template', contribType: ctype.filename },
    { icon: 'paket', extensions: ['paket.local'], special: 'local', contribType: ctype.filename },
    ...
    { icon: 'travis', extensions: ['.travis.yml'], special: 'yml', contribType: ctype.filename },
    { icon: 'tslint', extensions: ['tslint.json'], special: 'json', contribType: ctype.filename },
