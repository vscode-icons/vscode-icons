...
export const langDe: ILangResource = {
  ...
  welcomeMessageBegin: 'vscode-icons benutzt nun die offizielle API. Gehen Sie zu ',
  welcomeMessageEnd: 'und wählen Sie VSCode Icons, um zu aktivieren.',
  activationPath: {
  ...
  iconCustomizationMessage: 'Das Icon-Manifest wird regeneriert. ',
  iconRestoreMessage: 'Das Icon-Manifest wird zurückgesetzt. ',
