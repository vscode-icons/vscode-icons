...
export const constants = {
  ...
  extension: {
    ...
    distEntryNodeFilename: 'vscode-icons.bundle.js',
    uninstallEntryNodeFilename: 'uninstall.bundle.js',
    distEntryWebFilename: 'vscode-icons-web.bundle.js',
    uninstallEntryWebFilename: 'uninstall-web.bundle.js',
    outDirName: 'out',
    distDirName: 'dist',
    srcDirName: 'src',
    iconsDirName: 'icons',
