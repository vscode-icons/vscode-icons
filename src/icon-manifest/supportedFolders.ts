...
export const extensions: IFolderCollection = {
  ...
  supported: [
    ...
    { icon: 'binary', extensions: ['bin'], format: FileFormat.svg },
    ...
    { icon: 'config', extensions: ['config', '.config', 'ini', '.ini'], format: FileFormat.svg },
    ...
    { icon: 'library', extensions: ['lib'], format: FileFormat.svg },
    ...
    { icon: 'src', extensions: ['lib', 'src', 'source', 'sources'], format: FileFormat.svg },
