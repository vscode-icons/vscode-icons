...
export const extensions: IFolderCollection = {
  ...
  supported: [
    ...
    { icon: 'asset', extensions: ['assets', '.assets'], format: FileFormat.svg },
    { icon: 'aurelia', extensions: ['aurelia_project'], format: FileFormat.svg },
    { icon: 'audio', extensions: ['audio', '.audio', 'audios', '.audios'], format: FileFormat.svg },
    ...
    { icon: 'component', extensions: ['components', '.components'], format: FileFormat.svg },
    ...
    { icon: 'helper', extensions: ['helpers', '.helpers'], format: FileFormat.svg },
    ...
    { icon: 'route', extensions: ['route', 'routes', '_route', '_routes'], format: FileFormat.svg },
    ...
    { icon: 'temp', extensions: ['temp', '.temp', 'tmp', '.tmp'], format: FileFormat.svg },
    { icon: 'template', extensions: ['template', '.template', 'templates', '.templates'], format: FileFormat.svg },
    ...
    { icon: 'typings', extensions: ['typings', '@types'], format: FileFormat.svg },
    { icon: 'typings2', extensions: ['typings', '@types'], format: FileFormat.svg, disabled: true },
