...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'babel', extensions: ['.babelrc', '.babelrc.js', 'babel.config.js'], light: true, filename: true, format: FileFormat.svg },
    { icon: 'babel2', extensions: ['.babelrc', '.babelrc.js', 'babel.config.js'], light: true, filename: true, format: FileFormat.svg, disabled: true },
