...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'cabal', extensions: ['cabal'], light: true, format: FileFormat.svg },
    ...
    { icon: 'elixir', extensions: ['ex', 'exs', 'eex'], format: FileFormat.svg },
    ...
    { icon: 'graphviz', extensions: [], format: FileFormat.svg },
    ...
    { icon: 'json', extensions: ['JSON-tmLanguage'], languages: [languages.json], format: FileFormat.svg },
    ...
    { icon: 'script', extensions: ['wsf'], format: FileFormat.svg },
    ...
    { icon: 'twig', extensions: ['twig'], format: FileFormat.svg },
