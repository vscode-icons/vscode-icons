...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'ng_routing_ts2', extensions: ['-routing.module.ts'], format: FileFormat.svg, disabled: true },
    { icon: 'ng_routing_js2', extensions: ['-routing.module.js'], format: FileFormat.svg, disabled: true },
    ...
    { icon: 'tsconfig', extensions: ['tsconfig.json'], filename: true, format: FileFormat.svg },
