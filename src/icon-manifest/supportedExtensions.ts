...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'angular', extensions: ['.angular-cli.json', 'angular-cli.json', 'angular.json', '.angular.json'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'babel', extensions: ['.babelrc', 'babelrc.js', '.babelrc.js', 'babel.config.js', '.babelignore'], light: true, filename: true, format: FileFormat.svg },
    { icon: 'babel2', extensions: ['.babelrc', 'babelrc.js', '.babelrc.js', 'babel.config.js', '.babelignore'], light: true, filename: true, format: FileFormat.svg, disabled: true },
    ...
    { icon: 'browserslist', extensions: ['.browserslistrc', 'browserslist'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'crystal', extensions: [], languages: [languages.crystal], light: true, format: FileFormat.svg },
    ...
    { icon: 'darcs', extensions: ['.boringignore'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'drools', extensions: [], languages: [languages.drools], format: FileFormat.svg },
    { icon: 'dustjs', extensions: [], languages: [languages.dustjs], format: FileFormat.svg },
    ...
    { icon: 'helm', extensions: [], languages: [languages.helm], format: FileFormat.svg },
    ...
    { icon: 'json', extensions: [], light: true, languages: [languages.json, languages.textmatejson, languages.jsonc], format: FileFormat.svg },
    { icon: 'json_official', extensions: [], languages: [languages.json, languages.textmatejson, languages.jsonc], format: FileFormat.svg, disabled: true },
    { icon: 'json2', extensions: [], languages: [languages.json, languages.textmatejson, languages.jsonc], format: FileFormat.svg, disabled: true },
    ...
    { icon: 'license', extensions: ['license', 'licence'], filenamesGlob: ['license', 'licence'], extensionsGlob: ['md', 'txt'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'mocha', extensions: ['mocha.opts'], filename: true, format: FileFormat.svg },
    { icon: 'mojolicious', extensions: [], languages: [languages.mojolicious], format: FileFormat.svg },
    ...
    { icon: 'nuxt', extensions: [], filenamesGlob: ['nuxt.config'], extensionsGlob: ['js', 'ts'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'openHAB', extensions: [], light: true, languages: [languages.openHAB], format: FileFormat.svg },
    ...
    { icon: 'paket', extensions: [], filenamesGlob: ['paket'], extensionsGlob: ['dependencies', 'lock', 'references', 'template', 'local'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'pgsql', extensions: [], languages: [languages.pgsql], format: FileFormat.svg },
    ...
    { icon: 'postcssconfig', extensions: ['.postcssrc', '.postcssrc.js', 'postcss.config.js'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'prettier', extensions: ['.prettierrc', '.prettierignore'], light: true, filename: true, format: FileFormat.svg },
    { icon: 'prettier', extensions: [], filenamesGlob: ['prettier.config'], extensionsGlob: ['js', 'ts', 'coffee'], light: true, filename: true, format: FileFormat.svg },
    { icon: 'prettier', extensions: [], filenamesGlob: ['.prettierrc'], extensionsGlob: ['js', 'json', 'yml', 'yaml'], light: true, filename: true, format: FileFormat.svg },
    ...
    { icon: 'pyret', extensions: [], languages: [languages.pyret], format: FileFormat.svg },
    ...
    { icon: 'qsharp', extensions: [], languages: [languages.qsharp], format: FileFormat.svg },
    ...
    { icon: 'scilab', extensions: [], languages: [languages.scilab], format: FileFormat.svg },
    ...
    { icon: 'slang', extensions: [], languages: [languages.slang], format: FileFormat.svg },
    { icon: 'slice', extensions: [], languages: [languages.slice], format: FileFormat.svg },
    ...
    { icon: 'skipper', extensions: ['eskip'], languages: [languages.skipper], format: FileFormat.svg },
    ...
    { icon: 'solidarity', extensions: ['.solidarity', '.solidarity.json'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'stylable', extensions: [], languages: [languages.stylable], format: FileFormat.svg },
    ...
    { icon: 'tex', extensions: ['texi'], languages: [languages.tex, languages.latex, languages.bibtex, languages.doctex], light: true, format: FileFormat.svg },
    ...
    { icon: 'typo3', extensions: [], languages: [languages.typo3], format: FileFormat.svg },
    ...
    { icon: 'wasm', extensions: ['wasm'], languages: [languages.wasm], format: FileFormat.svg },
    {
      icon: 'webpack',
      extensions: [],
      filenamesGlob: [
    ...
    { icon: 'yamllint', extensions: ['.yamllint'], filename: true, format: FileFormat.svg },
