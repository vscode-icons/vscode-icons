...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'browserslist', extensions: ['.browserslistrc'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'prettier', extensions: [], filenamesGlob: ['prettierrc.config'], extensionsGlob: ['js', 'ts', 'coffee'], light: true, filename: true, format: FileFormat.svg },
    ...
    { icon: 'tex', extensions: ['texi'], languages: [languages.tex, languages.latex, languages.bibtex, languages.doctex, languages.expl3], light: true, format: FileFormat.svg },
