...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'karma', extensions: ['karma.conf.js', 'karma.conf.coffee', 'karma.conf.ts'], filename: true, format: FileFormat.svg },
    ...
    { icon: 'protractor', extensions: ['protractor.conf.js', 'protractor.conf.coffee', 'protractor.conf.ts'], filename: true, format: FileFormat.svg },
