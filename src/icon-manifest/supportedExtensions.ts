...
export const extensions: IFileCollection = {
  ...
  supported: [
    ...
    { icon: 'cmake', extensions: [], languages: [languages.cmake], format: FileFormat.svg },
    { icon: 'cmake', extensions: [], languages: [languages.cmakecache], format: FileFormat.svg },
    ...
    { icon: 'ocaml', extensions: ['OCamlMakefile', '.merlin'], filename: true, languages: [languages.ocaml], format: FileFormat.svg },
    ...
    { icon: 'terraform', extensions: [], languages: [languages.terraform], format: FileFormat.svg },
    { icon: 'testjs', extensions: ['test.js', 'spec.js'], format: FileFormat.svg },
    { icon: 'testts', extensions: ['test.ts', 'spec.ts'], format: FileFormat.svg },
    { icon: 'tex', extensions: [], languages: [languages.tex], light: true, format: FileFormat.svg },
    { icon: 'tex', extensions: ['texi'], languages: [languages.latex], light: true, format: FileFormat.svg },
