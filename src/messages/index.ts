export const messages = {
  ...
  iconCustomizationMessage: 'The icons manifest has been regenerated. Restart for changes to take effect.',
  iconRestoreMessage: 'The icons manifest has been restored. Restart for changes to take effect.',
