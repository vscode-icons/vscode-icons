...
- Enhancement: Moving to `tasks.json` and `launch.json` v2.0.0. ([@JimiC](https://github.com/JimiC) in [#1081](https://github.com/vscode-icons/vscode-icons/pull/1081))
...
- Feature: Added flat version of `php` logo. ([@JimiC](https://github.com/JimiC) in [#1062](https://github.com/vscode-icons/vscode-icons/pull/1062))
- Enhancement: Switch `pearl` to the official logo. ([@JimiC](https://github.com/JimiC) in [#1061](https://github.com/vscode-icons/vscode-icons/pull/1061))
