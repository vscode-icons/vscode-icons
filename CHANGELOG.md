...
- Feature: Support for `Rego Policies`. ([@leefaus](https://github.com/leefaus) in [#2590](https://github.com/vscode-icons/vscode-icons/pull/2590))
- Enhancement: Update `mlang` language id. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2587](https://github.com/vscode-icons/vscode-icons/pull/2587))
- Enhancement: Add `tool` folder to `tools` icon. ([@jorgecoca](https://github.com/jorgecoca) in [#2584](https://github.com/vscode-icons/vscode-icons/pull/2584))
- Enhancement: Update `TypeScript` & `TypeScript Definitions` icons. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2582](https://github.com/vscode-icons/vscode-icons/pull/2582))
- Feature: Support for `hygen`. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2578](https://github.com/vscode-icons/vscode-icons/pull/2578))
- Feature: Support for `Numpy`. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2574](https://github.com/vscode-icons/vscode-icons/pull/2574))
- Enhancement: Add old `gradle` icon. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2573](https://github.com/vscode-icons/vscode-icons/pull/2573))
- Enhancement: Add `.tgz` & `.bz2` to archive files. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2572](https://github.com/vscode-icons/vscode-icons/pull/2572))
...
- Feature: Support for `CDDL`. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2555](https://github.com/vscode-icons/vscode-icons/pull/2555))
- Enhancement: Update `storybook` folder icon. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2554](https://github.com/vscode-icons/vscode-icons/pull/2554))
- Enhancement: Add `.storybook` to `story` extensions. ([@jun-sheaf](https://github.com/jun-sheaf) in [#2553](https://github.com/vscode-icons/vscode-icons/pull/2553))
- Feature: Support for `cubit`. ([@felangel](https://github.com/felangel) in [#2551](https://github.com/vscode-icons/vscode-icons/pull/2551))
- Feature: Support for `xmake`. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2550](https://github.com/vscode-icons/vscode-icons/pull/2550))
- Feature: Support for `ng-tailwind`. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2549](https://github.com/vscode-icons/vscode-icons/pull/2549))
- Feature: Support for `Dependabot`. ([@KingDarBoja](https://github.com/KingDarBoja) in [#2548](https://github.com/vscode-icons/vscode-icons/pull/2548))
- Feature: Support for `Nix`. ([@DavSanchez](https://github.com/DavSanchez) in [#2540](https://github.com/vscode-icons/vscode-icons/pull/2540))
